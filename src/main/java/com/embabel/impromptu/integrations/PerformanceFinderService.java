...
public class PerformanceFinderService {
    ...
    /**
     * Create a Tool that can be directly added to an action's tool set.
     *
     * @param user The user
     * @param workId The work ID to search for
     * @return Tool for finding performances
     */
    public Tool asToolFor(ImpromptuUser user, String workId) {
        return createPerformanceFinderTool(user, workId);
    }
